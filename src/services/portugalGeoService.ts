...
const PORTUGAL_CITIES: Record<string, LocationCoordinates> = {
  ...
  'grandola': { lat: 38.1764, lng: -8.5672, cidade: 'Grândola', distrito: 'Setúbal', regiao: 'Alentejo' },
  'grândola': { lat: 38.1764, lng: -8.5672, cidade: 'Grândola', distrito: 'Setúbal', regiao: 'Alentejo' },
  'alcacer do sal': { lat: 38.3728, lng: -8.5139, cidade: 'Alcácer do Sal', distrito: 'Setúbal', regiao: 'Alentejo' },
  'alcácer do sal': { lat: 38.3728, lng: -8.5139, cidade: 'Alcácer do Sal', distrito: 'Setúbal', regiao: 'Alentejo' },
  ...
  'vendas novas': { lat: 38.6786, lng: -8.4578, cidade: 'Vendas Novas', distrito: 'Évora', regiao: 'Alentejo' },
  ...
  'reguengos de monsaraz': { lat: 38.4239, lng: -7.5344, cidade: 'Reguengos de Monsaraz', distrito: 'Évora', regiao: 'Alentejo' },
  'borba': { lat: 38.8058, lng: -7.4561, cidade: 'Borba', distrito: 'Évora', regiao: 'Alentejo' },
  'vila vicosa': { lat: 38.7806, lng: -7.4189, cidade: 'Vila Viçosa', distrito: 'Évora', regiao: 'Alentejo' },
  'vila viçosa': { lat: 38.7806, lng: -7.4189, cidade: 'Vila Viçosa', distrito: 'Évora', regiao: 'Alentejo' },
  ...
  'serpa': { lat: 37.9444, lng: -7.5972, cidade: 'Serpa', distrito: 'Beja', regiao: 'Alentejo' },
  ...
  'aljustrel': { lat: 37.8769, lng: -8.1639, cidade: 'Aljustrel', distrito: 'Beja', regiao: 'Alentejo' },
  'ferreira do alentejo': { lat: 38.0583, lng: -8.1147, cidade: 'Ferreira do Alentejo', distrito: 'Beja', regiao: 'Alentejo' },
  'vidigueira': { lat: 38.1889, lng: -7.8000, cidade: 'Vidigueira', distrito: 'Beja', regiao: 'Alentejo' },
  'cuba': { lat: 38.1656, lng: -7.8931, cidade: 'Cuba', distrito: 'Beja', regiao: 'Alentejo' },
  'mertola': { lat: 37.6389, lng: -7.6625, cidade: 'Mértola', distrito: 'Beja', regiao: 'Alentejo' },
  'mértola': { lat: 37.6389, lng: -7.6625, cidade: 'Mértola', distrito: 'Beja', regiao: 'Alentejo' },
  ...
  'campo maior': { lat: 39.0117, lng: -7.0678, cidade: 'Campo Maior', distrito: 'Portalegre', regiao: 'Alentejo' },
